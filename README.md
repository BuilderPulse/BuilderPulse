...
**Today: WordPress supply chain attack: someone bought 30, Backblaze silently stopped backing up cloud-synced folders, "Claude managed agents" is the fastest-rising search.**
...
**今日: WordPress 供应链攻击、Backblaze 悄然停止备份云同步文件夹、"Claude managed agents"。**
